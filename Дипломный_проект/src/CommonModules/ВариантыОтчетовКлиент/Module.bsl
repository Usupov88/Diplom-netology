...
Процедура ОткрытьФормуОтчета(Знач ФормаВладелец, Знач Вариант, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	ОткрытьФорму(ПолноеИмяОтчета + ".ВКМ_КалендарьСпециалистов", ПараметрыОткрытия, Неопределено, Истина);
...
Процедура ОткрытьДиалогРазмещенияВариантовВРазделах(Варианты, Владелец = Неопределено) Экспорт
	...
	ОткрытьФорму("Справочник.ВариантыОтчетов.ВКМ_КалендарьСпециалистов.РазмещениеВРазделах", ПараметрыОткрытия, Владелец);
